...
<body>
  <h1>Adventures in Tradespace Exploration: Stage 1</h1>

  <div class="nav_buttons">
    <form action="stage2.php" method="get"  style="margin-left: auto;">
        <input type="hidden" name="group_id" value="<?php echo $group_id; ?>">
        <button type="submit" class="nav_submit">Continue to Stage 2</button>
    </form>
  </div>
